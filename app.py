...
# Embed Tableau dashboard using the modified HTML code
html_code = """
<style>
    .tableauPlaceholder iframe { border: none; }
    .tableauPlaceholder .footer {
        display: none !important; /* Hide Tableau Public footer */
    }
</style>
...
<script type='text/javascript'>
    var divElement = document.getElementById('viz1732313646031');
